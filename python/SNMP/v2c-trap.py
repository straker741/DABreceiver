...
config.addTargetAddr(
    snmpEngine, 'my-nms',
    udp.domainName, ('192.168.178.34', 162),
    'my-creds',
...
sendRequestHandle = ntfOrg.sendVarBinds(
    ...
    [
        ...
        ((1, 3, 6, 1, 2, 1, 1, 1, 0), v2c.OctetString('Example Notificator')),              # 1.3.6.1.2.1.1.1 - sysDescr
        ((1, 3, 6, 1, 2, 1, 1, 5, 0), v2c.OctetString('Notificator Example'))               # 1.3.6.1.2.1.1.5 - sysName
    ],
    cbFun
)
