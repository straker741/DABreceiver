...
expect "MariaDB \\\[bakalarka]>"
send "CREATE TABLE IF NOT EXISTS dabtable ( id int not null auto_increment primary key, SNR REAL(13,10), bandwidth int, datetime timestamp DEFAULT current_timestamp );\n"
expect "MariaDB \\\[bakalarka]>"
